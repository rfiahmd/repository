...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        ...
        // Tentukan field mana yang akan digunakan untuk login
    ...
    protected function getLoginField(): string
    {
        ...
        // Jika input berupa angka, dianggap sebagai NIP-NIM
        if (is_numeric($login)) {
            return 'nip_nim'; // sesuaikan dengan nama kolom di database
        }
