  <div class="col-xxl-auto col-xl-3 col-sm-8 box-col-3">
    <div class="row">
      <div class="col-xl-12">
            ...
            <div class="widget-content">
              <div class="widget-round secondary">
                <div class="bg-round"><svg>
                    <use href="{{ asset('') }}assets/svg/icon-sprite.svg#c-revenue">
                    </use>
              ...
              <div>
                <h4><span class="counter" data-target="{{ $totalDokumen }}">0</span></h4><span class="f-light">Total
                  Dokumen</span>
              </div>
            </div>
          ...
          <div class="card widget-1">
            <div class="card-body">
              <div class="widget-content">
                ...
                <div>
                  <h4> <span class="counter" data-target="{{ $totalKategori }}">0</span></h4><span class="f-light">Total
                    Kategori</span>
                </div>
              </div>
              <div class="font-danger f-w-500"><i class="bookmark-search me-1" data-feather="trending-down"></i><span
                  class="txt-danger">-40%</span></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card widget-1">
          <div class="card-body">
            <div class="widget-content">
              ...
              <div>
                <h4> <span class="counter" data-target="{{ $totalFakultas }}">0</span></h4><span class="f-light">Total
                  Fakultas</span>
              </div>
            </div>
            <div class="font-danger f-w-500"><i class="bookmark-search me-1" data-feather="trending-down"></i><span
          ...
          <div class="card widget-1">
            <div class="card-body">
              <div class="widget-content">
                ...
                <div>
                  <h4 class="counter" data-target="{{ $totalDosen }}">0</h4><span class="f-light">Total Dosen</span>
                </div>
              </div>
              <div class="font-success f-w-500"><i class="bookmark-search me-1" data-feather="trending-up"></i><span
                  class="txt-success">+50%</span></div>
        ...
        <div class="card widget-1">
          <div class="card-body">
            <div class="widget-content">
              ...
              <div>
                <h4> <span class="counter" data-target="{{ $totalJurusan }}">0</span></h4><span class="f-light">Total
                  Jurusan</span>
              </div>
            </div>
            <div class="font-danger f-w-500"><i class="bookmark-search me-1" data-feather="trending-down"></i><span
          ...
          <div class="card widget-1">
            <div class="card-body">
              <div class="widget-content">
                ...
                <div>
                  <h4 class="counter" data-target="{{ $totalMahasiswa }}">0</h4><span class="f-light">Total
                    Mahasiswa</span>
                </div>
              </div>
              <div class="font-success f-w-500"><i class="bookmark-search me-1" data-feather="trending-up"></i><span
