                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    ...
                                    <input type="hidden" name="search_type" id="hiddenSearchType"
                                        value="{{ $search_type ?? 'judul' }}">

                                    {{-- Tab Pane Judul --}}
                                    <div class="tab-pane fade {{ ($search_type ?? 'judul') == 'judul' ? 'in active' : '' }}"
                                        id="book">
                                        <form action="{{ route('dokumen.search') }}" method="GET">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="judul_query" class="form-control"
                                    ...
                                    {{-- Tab Pane Abstrak --}}
                                    <div class="tab-pane fade {{ ($search_type ?? '') == 'abstrak' ? 'in active' : '' }}"
                                        id="author">
                                        <form action="{{ route('dokumen.search') }}" method="GET">
                                            {{-- Input tersembunyi untuk search_type di setiap form --}}
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="abstrak_query" class="form-control"
                                                    placeholder="Masukkan Abstrak dokumen"
                                                    value="{{ old('abstrak_query', $abstrak_query ?? '') }}">
                                                <div class="input-group-btn">
                                                    <button type="submit" class="btn btn-primary">
                                                        <i class="icofont icofont-search-alt-2"></i>
                                                    </button>
                                    ...
                                    {{-- Tab Pane Kategori --}}
                                    <div class="tab-pane fade {{ ($search_type ?? '') == 'kategori' ? 'in active' : '' }}"
                                        id="publisher">
                                        <form action="{{ route('dokumen.search') }}" method="GET">
                                            {{-- Input tersembunyi untuk search_type di setiap form --}}
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            ...
                                            @else
                                                ...
                                                <img width="150px" src="{{ asset('images/default_thumbnail.png') }}"
                                                    class="media-object" alt="Tidak Ada Thumbnail">
                                            @endif
